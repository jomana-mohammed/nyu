...
const ResearchesPage = () => {
    ...
    return(
        <div>
                ...
                <div className="p-8">
                    ...
                    <div className="flex flex-col md:flex-row" >
                        ...
                        <div style={{marginLeft:'150px' }}>
                            <Image src={researchImg} alt="Description" className="shadow-image" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="bg-gray-50 flex-col md:flex-row" >
                <div className="p-12" style={{ marginTop:'150px', marginBottom:'40px' , display: 'flex', justifyContent: 'center' }}>
            ...
            <div>
                <Image src={researchImg2} alt="Description" style={{ width:'100%' , height:'400px' , objectFit:'contain' , marginTop:'-40px'}} />
            </div>
