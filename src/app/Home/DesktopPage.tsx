...
export default function DesktopHome() {
    ...
    return (
        <div>
        <div className="flex items-center justify-center mt-40 flex-row md:flex-col">
            ...
            <Image style={{ width: '600px', height: '400px' }} src={HelloImg} alt="NYU image" />
                <div className="bg-neutral-800 hover:bg-purple-900 transition-colors duration-500 m-8" style={{ width: '600px', height: '300px' }}>
                    ...
                    <div className="bg-neutral-900 hover:bg-purple-900 transition-colors duration-500 rounded-[6px] flex items-center justify-center" style={{ width: '150px', marginLeft: '50px' , marginTop:'15px' }}>
        ...
        <div className="mt-40 text-white" >
            ...
            <div className="flex items-center justify-center" >
                <div className="m-8 bg-sky-900 flex hover:bg-purple-900 transition-colors duration-500" style={{ height: '350px'}}>
            ...
            <div className="flex items-center justify-center mt-8" >
                <div className="m-8 bg-neutral-500 flex hover:bg-purple-900 transition-colors duration-500" style={{height: '350px' }}>
                <div className="ml-4">
